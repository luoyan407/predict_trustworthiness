...
__all__ = ['CIFAR10DataLoader', 
            'ImageNetDataLoader', 
            'CIFAR100DataLoader', 
            'ImageNetDataLoader_shufflable']
...
class ImageNetDataLoader_shufflable(DataLoader):
    def __init__(self, data_dir, split='train', 
            image_size=224, batch_size=16, num_workers=8, shuffle=False):
        ...
        self.dataset = ImageFolder(root=os.path.join(data_dir, split), transform=transform)
        super(ImageNetDataLoader_shufflable, self).__init__(
            dataset=self.dataset,
            batch_size=batch_size,
            shuffle=shuffle,
            num_workers=num_workers)
